...
// */
//public class S3Util {
//  public static final String TAG = S3Util.class.getSimpleName();
//
...
//    if (sS3Client == null) {
//      AWSCredentialsProvider credentials = getCredProvider(context);
//      sS3Client = new AmazonS3Client(credentials, Region.getRegion(Regions.US_WEST_2));
//
//      try {
...
//
//
////pool id: us-west-2:14a7d6f0-2535-436b-aa09-2732161f015e
////bucket: zenmpark
////region us-west-2
////https://zenmpark.s3-us-west-2.amazonaws.com///profile_image_505316ca5.png
////zenmpark.s3-us-west-2.amazonaws.com
